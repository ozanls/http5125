...
namespace Cumulative1.Controllers
{
    ...
    private SchoolDbContext School = new SchoolDbContext();
        ...
        /// <returns>
        /// [{"StudentId": "1", "StudentName": "Sarah Valdez", "StudentNumber": "N1678", "StudentEnrolDate": "2018-06-18 00:00:00"},
        /// {"StudentId": "2", "StudentName": "Jennifer Faulkner", "StudentNumber": "N1679}, "StudentEnrolDate": "2018-08-02 00:00:00"]
        /// </returns>
        [HttpGet]
    ...
    public List<Student> ListStudents()
    {
        ...
        while (ResultSet.Read())
        {
            ...
            string StudentName = ResultSet["studentfname"] + " " + ResultSet["studentlname"].ToString();
    ...
    /// <returns>
    /// {"StudentId": "1", "StudentName": "Alexander Bennett", "EmployeeNumber": "T378"}
    /// </returns>
    [HttpGet]
    ...
    public Student FindStudent(int StudentID)
    {
        ...
        while (ResultSet.Read())
        {
            SelectedStudent.StudentName = ResultSet["studentfname"] + " " + ResultSet["studentlname"].ToString();
