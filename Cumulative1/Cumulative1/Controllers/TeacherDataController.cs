...
namespace Cumulative1.Controllers
{
    public class TeacherDataController : ApiController
    {
        ...
        /// <returns>
        /// [{"TeacherId": "1", "TeacherName": "Alexander Bennett", "EmployeeNumber": "T378", "TeacherHireDate": "2016-08-05 00:00:00" "TeacherSalary": "55.30"},
        /// {"TeacherId": "2", "TeacherName": "Caitlin Cummings", "EmployeeNumber": "T318", "TeacherHireDate": "2016-06-10 00:00:00" "TeacherSalary": "62.77"}]
        /// </returns>
        [HttpGet]
        ...
        public Teacher FindTeacher(int TeacherID)
        {
            ...
            while (ResultSet.Read())
            {
                SelectedTeacher.TeacherName = ResultSet["teacherfname"] + " " + ResultSet["teacherlname"].ToString();
